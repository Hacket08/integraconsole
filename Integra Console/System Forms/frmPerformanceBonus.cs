...
public partial class frmPerformanceBonus : Form
{

    DataTable _tblDisplay = new DataTable();
    public frmPerformanceBonus()
    {
        InitializeComponent();
    }

    private void frmPerformanceBonus_Load(object sender, EventArgs e)
    {
        //rbAll.Checked = true;
