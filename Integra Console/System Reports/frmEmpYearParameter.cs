...
public partial class frmEmpYearParameter : Form
{

    public static string _RequestType;
    public static string _QueryGenerated;
    public frmEmpYearParameter()
    {
        InitializeComponent();
    }

    private void frmEmpYearParameter_Load(object sender, EventArgs e)
    {
        //rbAll.Checked = true;
...
, 'DATE COVERED FROM " + _refDateHiredFrom + @" TO " + _refDateHiredTo + @"' AS [SubTitle]
							FROM [vwsLoanFile] A 
										...
										INNER JOIN vwsAccountCode D ON A.AccountCode = D.AccountCode  
WHERE B.ConfiLevel IN (" + _refConfiLevel + @")
AND A.AccountCode IN ('8-502','8-503','8-504','8-516','8-522')
...
AND A.AccountCode IN ('8-510','8-511','8-514','8-515','8-517','8-518','8-519')
    ...
    private void frmEmpYearParameter_FormClosing(object sender, FormClosingEventArgs e)
    {
