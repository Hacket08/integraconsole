...
public partial class frmEmployeeDataParameter : Form
{

    public static string _RequestType;
    public static string _QueryGenerated;
    public frmEmployeeDataParameter()
    {
        InitializeComponent();
    }

    private void frmEmployeeDataParameter_Load(object sender, EventArgs e)
    {
        rbAll.Checked = true;
    ...
    private void btnUpload_Click(object sender, EventArgs e)
    {
        ...
        {
            case 1:
                clsDeclaration.sReportPath = Application.StartupPath + @"\Reports\Employee Summary Report.rpt";


                if (rbAll.Checked == true)
                {
                    clsDeclaration.sQueryString = sqlQueryOutput("", "", "", "", dtpDateHiredFrom.Value.ToShortDateString(), dtpDateHiredTo.Value.ToShortDateString(), "",
                                        clsDeclaration.sConfiLevel,
                                        clsDeclaration.sConfiLevelSelection);
                }
                else
                {
                    clsDeclaration.sQueryString = sqlQueryOutput(_Branch, cboArea.Text, _Deparment, _selActive, dtpDateHiredFrom.Value.ToShortDateString(), dtpDateHiredTo.Value.ToShortDateString(), _Company,
                                        clsDeclaration.sConfiLevel,
                                        clsDeclaration.sConfiLevelSelection);
                }
                break;
            case 2:
                ...
                if (rbAll.Checked == true)
                {
                    clsDeclaration.sQueryString = sqlQueryOutputEmployeeDetailed("", "", "", "", dtpDateHiredFrom.Value.ToShortDateString(), dtpDateHiredTo.Value.ToShortDateString(), "",
                                        clsDeclaration.sConfiLevel,
                                        clsDeclaration.sConfiLevelSelection);
                }
                else
                {
                    clsDeclaration.sQueryString = sqlQueryOutputEmployeeDetailed(_Branch, cboArea.Text, _Deparment, _selActive, dtpDateHiredFrom.Value.ToShortDateString(), dtpDateHiredTo.Value.ToShortDateString(), _Company,
                                        clsDeclaration.sConfiLevel,
                                        clsDeclaration.sConfiLevelSelection);
                }
                break;
                                ...
                                string _refConfiSelection = "")
    {
        ...
        {
            case "0":
                _strActive = "Employee Summary Report - Active";
                break;
            case "1":
                _strActive = "Employee Summary Report - In-Active";
                break;
            default:
                _strActive = "Employee Summary Report";
                break;
        }
...
WHERE A.ConfiLevel IN (" + _refConfiLevel + @")
        ...
        if (_refActive == "0")
        {
            ...
            //{
            //    _sqlSyntax = _sqlSyntax + @" 
            //                            AND XX.DateHired <= '" + _refDateHired + @"'";
            //}
            //else
            //{
            //    _sqlSyntax = _sqlSyntax + @" 
        ...
        if (_refActive == "1")
        {
            ...
            //{
            //    _sqlSyntax = _sqlSyntax + @" 
            //                            AND XX.DateFinish <= '" + _refDateHired + @"'";
            //}
            //else
            //{
            //    _sqlSyntax = _sqlSyntax + @" 
    ...
    private string sqlQueryOutputEmployeeDetailed(string _refBranch = "",
                                string _refArea = "",
                                string _refDepartment = "",
                                string _refActive = "",
                                string _refDateHiredFrom = "",
                                ...
                                string _refConfiSelection = "")
    {
        ...
        {
            case "0":
                _strActive = "Employee Detailed Report - Active";
                break;
            case "1":
                _strActive = "Employee Detailed Report - In-Active";
                break;
            default:
                _strActive = "Employee Detailed Report";
                break;
        }
...
WHERE A.ConfiLevel IN (" + _refConfiLevel + @")
    ...
    private void frmEmployeeDataParameter_FormClosing(object sender, FormClosingEventArgs e)
    {
