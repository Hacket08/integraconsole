...
public partial class frmCustomPayrollSetup : Form
{
    private static DataTable _CompanyList = new DataTable();
    public frmCustomPayrollSetup()
    {
        InitializeComponent();
    }

    private void frmCustomPayrollSetup_Load(object sender, EventArgs e)
    {
    ...
    {
        frmCustomPayrollData frmCustomPayrollData = new frmCustomPayrollData();
        frmCustomPayrollData.ShowDialog();
